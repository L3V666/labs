...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \huge \textbf{1.2.1 \\ Определение скорости полёта пули при помощи баллистического маятника}
        \noindent\rule{\textwidth}{1pt}
...
\[u=\varphi\frac{\sqrt{kI}}{mr}\approx\frac{x}{d}\frac{\sqrt{kI}}{mr}\]
...
Величина $\sqrt{kI} = (0.304 \pm 0.006) \tfrac{\text{кг}\cdot\text{м}^2}{c}$
...
Средняя скорость $\overline{u}=89.34$ м/с. Погрешность $\varepsilon_u=1$ \%
